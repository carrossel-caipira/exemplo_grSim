...
class SimulatorError final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR SimulatorError(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  SimulatorError* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const SimulatorError& from) {
    SimulatorError::MergeImpl(*this, from);
  }
  private:
