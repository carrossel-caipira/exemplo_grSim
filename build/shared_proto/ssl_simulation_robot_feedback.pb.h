...
class RobotFeedback final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR RobotFeedback(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void MergeFrom( const RobotFeedback& from) {
    RobotFeedback::MergeImpl(*this, from);
  }
  private:
...
class RobotControlResponse final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR RobotControlResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void MergeFrom( const RobotControlResponse& from) {
    RobotControlResponse::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
inline ::RobotFeedback* RobotControlResponse::mutable_feedback(int index) {
  ...
  return _impl_.feedback_.Mutable(index);
}
...
inline const ::RobotFeedback& RobotControlResponse::_internal_feedback(int index) const {
  return _impl_.feedback_.Get(index);
}
